        ...
        <div className="form">
          ...
          <form onChange={handleChange}>
            <div className="required-container">
              ...
              {error1 ? <label className="required"> *(Required)</label> : ""}
            </div>
            ...
            <div className="required-container">
              ...
              {error2 ? <label className="required"> *(Required)</label> : ""}
            </div>

            <select
              className="commencement-year"
            ...
            <div className="year-12-container">
              <h1 className="year-12-units">
                Which Year 12 Unit(s) have you completed?
              </h1>
